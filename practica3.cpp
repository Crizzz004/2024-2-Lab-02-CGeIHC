...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide1 R
		...
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide2 R
		...
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide3 R

		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.05f, -0.02f, -3.32f));
		model = glm::scale(model, glm::vec3(0.26f, 0.26f, 0.26f));
		...
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide4 R

		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.05f, -0.02f, -2.67f));
		model = glm::scale(model, glm::vec3(0.26f, 0.26f, 0.26f));
		model = glm::rotate(model, 60 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide5 R

		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.55f, -0.02f, -3.58f));
		model = glm::scale(model, glm::vec3(0.26f, 0.26f, 0.26f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide6 R

		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.55f, -0.02f, -2.93f));
		model = glm::scale(model, glm::vec3(0.26f, 0.26f, 0.26f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide7 R
		...
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide8 R

		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(1.05f, -0.02f, -3.25f));
		model = glm::scale(model, glm::vec3(0.26f, 0.26f, 0.26f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide9 R
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide1 V
		...
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide2 V
		...
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide3 V

		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.4f, 0.5f, -2.60f));
		model = glm::scale(model, glm::vec3(0.26f, -0.26f, 0.26f));
		...
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide4 V

		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.95f, 0.5f, -2.9f));
		model = glm::scale(model, glm::vec3(0.26f, -0.26f, 0.26f));
		model = glm::rotate(model, 360 * toRadians, glm::vec3(0.1f, 0.0f, 0.7));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide5 V
		...
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide6 V
		...
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide7 V
		
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.6f, 1.0f, -2.9f));
		model = glm::scale(model, glm::vec3(0.26f, -0.26f, 0.26f));
		model = glm::rotate(model, 360 * toRadians, glm::vec3(0.1f, 0.0f, 0.7));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide8 V
		...
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMesh(); //Piramide9 V
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.4f, 0.5f, -3.91f));
		model = glm::scale(model, glm::vec3(0.26f, -0.26f, 0.26f));
		model = glm::rotate(model, 360 * toRadians, glm::vec3(0.1f, 0.0f, 0.7));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.95f, 0.5f, -3.61f));
		model = glm::scale(model, glm::vec3(0.26f, -0.26f, 0.26f));
		model = glm::rotate(model, 360 * toRadians, glm::vec3(0.1f, 0.0f, 0.7));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.6f, 1.0f, -3.61f));
		model = glm::scale(model, glm::vec3(0.26f, -0.26f, 0.26f));
		model = glm::rotate(model, 360 * toRadians, glm::vec3(0.1f, 0.0f, 0.7));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		/*
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.5f, -3.62f));
		model = glm::scale(model, glm::vec3(5.0f, 0.07f, 5.0f));
		//otras transformaciones para el objeto
		//model = glm::scale(model, glm::vec3(0.5f,0.5f,0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.322f, 0.62f, 0.337f);
